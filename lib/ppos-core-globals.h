...
//extern task_t* taskDiskMgr; // Ponterio para a tarefa gerente do disco
...
extern unsigned int _systemTime; // armazena o tempo global do sistema, em ticks do relogio
